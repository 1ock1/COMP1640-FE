    ...
    <div>
      <Container maxWidth="xl">
        <Box>
          ...
          <Grid container spacing={2} justifyContent={"space-between"}>
            <Grid item xs={2}>
              ...
              >
                <Typography variant="h6">
                  {FacultyData.totalContributions}
                </Typography>
            ...
            <Grid item xs={2}>
              ...
              >
                <Typography variant="h6">
                  {FacultyData.totalUploadedContributions}
                </Typography>
            ...
            <Grid item xs={2}>
              ...
              >
                <Typography variant="h6">
                  {FacultyData.totalPublishedContributions}
                </Typography>
        ...
        <Stack
          ...
          textAlign="center"
          spacing={2}
          divider={<Divider orientation="vertical" flexGrow />}
        >
          <Box
            sx={{
              p: 2,
