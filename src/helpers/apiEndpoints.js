export const apiEndpointLocal = "https://comp1640-stg.azurewebsites.net/"; //or replace to your localhost
...
export const path = {
  ...
  report: {
    ...
    totalContribution: "api/Report/TotalContribution",
    percentageSubmission: "api/Report/PercentageSubmission",
